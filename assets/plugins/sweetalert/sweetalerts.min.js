  ...
  $("#basic-alert").on("click", function () {
    ...
    $("#html-alert").on("click", function () {
      Swal.fire({
        ...
        type: "info",
        html: 'You can use <b>bold text</b>, <a href="../../../https@pixinvent.com/default.htm" target="_blank">links</a> and other HTML tags',
        showCloseButton: !0,
        showCancelButton: !0,
        focusConfirm: !1,
    ...
    $("#ajax-request").on("click", function () {
      Swal.fire({
        ...
        preConfirm: function (t) {
          return fetch("../../../https@api.github.com/users/" + t)
            .then(function (t) {
